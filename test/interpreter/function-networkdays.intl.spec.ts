...
describe('Function NETWORKDAYS_INTL', () => {
  it('should return #NA! error with the wrong number of arguments', () => {
    const engine = HyperFormula.buildFromArray([
      ['=NETWORKDAYS_INTL(1)', '=NETWORKDAYS_INTL(1, 1, 1, 1, 1)'],
    ])
  ...
  it('should check for types or value of third argument', () => {
    const engine = HyperFormula.buildFromArray([
      ['=NETWORKDAYS_INTL(0, 1, TRUE())'],
      ['=NETWORKDAYS_INTL(0, 1, "1")'],
      ['=NETWORKDAYS_INTL(0, 1, "1010102")'],
      ['=NETWORKDAYS_INTL(0, 1, -1)'],
      ['=NETWORKDAYS_INTL(0, 1, "1111111")'],
    ])
  ...
  it('works correctly for first two arguments', () => {
    const engine = HyperFormula.buildFromArray([
      ['=NETWORKDAYS_INTL(0, 1)'],
      ['=NETWORKDAYS_INTL(0, 6)'],
      ['=NETWORKDAYS_INTL(0, 6.9)'],
      ['=NETWORKDAYS_INTL(6.9,0.1)'],
    ])
  ...
  it('today', () => {
    const engine = HyperFormula.buildFromArray([
      ['=NETWORKDAYS_INTL("29/09/2020", "29/09/2020")'],
      ['=NETWORKDAYS_INTL("29/09/2020", "29/09/2020", 3)'],
      ['=NETWORKDAYS_INTL("29/09/2020", "29/09/2020", 4)'],
      ['=NETWORKDAYS_INTL("29/09/2020", "29/09/2020", 13)'],
      ['=NETWORKDAYS_INTL("29/09/2020", "29/09/2020", "1011111")'],
    ])
  ...
  it('this year', () => {
    const engine = HyperFormula.buildFromArray([
      ...
      ['=NETWORKDAYS_INTL("01/01/2020", "31/12/2020", 1)'],
      ['=NETWORKDAYS_INTL("01/01/2020", "31/12/2020", 1, A1:A1)'],
      ['=NETWORKDAYS_INTL("01/01/2020", "31/12/2020", 1, A1:B1)'],
      ['=NETWORKDAYS_INTL("01/01/2020", "31/12/2020", 1, A1:D1)'],
      ['=NETWORKDAYS_INTL("01/01/2020", "31/12/2020", 1, A1:E1)'],
    ])
  ...
  it('should output correct values', () => {
    const engine = HyperFormula.buildFromArray([
      ...
      ['=NETWORKDAYS_INTL(A1, A1+100, "0000000", A1:J1)'],
      ['=NETWORKDAYS_INTL(A1+7, A1+20, "0000000", A1:J1)'],
      ['=NETWORKDAYS_INTL(A1+7, A1+100, "0000000", A1:J1)'],
      ['=NETWORKDAYS_INTL(A1+13, A1+50, "0000000", A1:J1)'],
      ['=NETWORKDAYS_INTL(A1+50, A1+56, "0000000", A1:J1)'],
    ])
  ...
  it('checks types in last argument', () => {
    const engine = HyperFormula.buildFromArray([
      [true, '\'1', null, '=NA()'],
      ['=NETWORKDAYS_INTL(1000, 1, 1, A1:A1)'],
      ['=NETWORKDAYS_INTL(1000, 1, 1, B1:B1)'],
      ['=NETWORKDAYS_INTL(1000, 1, 1, C1:C1)'],
      ['=NETWORKDAYS_INTL(1000, 1, 1, A1:D1)'],
    ])

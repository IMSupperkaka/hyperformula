...
describe('Function WORKDAY_INTL', () => {
  it('should return #NA! error with the wrong number of arguments', () => {
    const engine = HyperFormula.buildFromArray([
      ['=WORKDAY_INTL(1)', '=WORKDAY_INTL(1, 1, 1, 1, 1)'],
    ])
  ...
  it('should check for types or value of third argument', () => {
    const engine = HyperFormula.buildFromArray([
      ['=WORKDAY_INTL(0, 1, TRUE())'],
      ['=WORKDAY_INTL(0, 1, "1")'],
      ['=WORKDAY_INTL(0, 1, "1010102")'],
      ['=WORKDAY_INTL(0, 1, -1)'],
      ['=WORKDAY_INTL(0, 1, "1111111")'],
    ])
  ...
  it('works correctly for first two arguments', () => {
    const engine = HyperFormula.buildFromArray([
      ['=WORKDAY_INTL(1000, 1)'],
      ['=WORKDAY_INTL(1000.9, 1.9)'],
      ['=WORKDAY_INTL(1000.9, -1)'],
      ['=WORKDAY_INTL(1000, -1.9)'],
      ['=WORKDAY_INTL(1000, 0)'],
      ['=WORKDAY_INTL(1000, 0.9)'],
      ['=WORKDAY_INTL(1000, -0.9)'],
    ])
  ...
  it('today plus 1', () => {
    const engine = HyperFormula.buildFromArray([
      ['=WORKDAY_INTL("29/09/2020", 1)'],
      ['=WORKDAY_INTL("29/09/2020", 1, 3)'],
      ['=WORKDAY_INTL("29/09/2020", 1, 4)'],
      ['=WORKDAY_INTL("29/09/2020", 1, 5)'],
      ['=WORKDAY_INTL("29/09/2020", 1, 6)'],
      ['=WORKDAY_INTL("29/09/2020", 1, 13)'],
      ['=WORKDAY_INTL("29/09/2020", 1, 14)'],
      ['=WORKDAY_INTL("29/09/2020", 1, 15)'],
      ['=WORKDAY_INTL("29/09/2020", 1, "1011111")'],
    ])
  ...
  it('today minus 1', () => {
    const engine = HyperFormula.buildFromArray([
      ['=WORKDAY_INTL("29/09/2020", -1)'],
      ['=WORKDAY_INTL("29/09/2020", -1, 2)'],
      ['=WORKDAY_INTL("29/09/2020", -1, 3)'],
      ['=WORKDAY_INTL("29/09/2020", -1, 4)'],
      ['=WORKDAY_INTL("29/09/2020", -1, 5)'],
      ['=WORKDAY_INTL("29/09/2020", -1, 12)'],
      ['=WORKDAY_INTL("29/09/2020", -1, 13)'],
      ['=WORKDAY_INTL("29/09/2020", -1, 14)'],
      ['=WORKDAY_INTL("29/09/2020", -1, "1011111")'],
    ])
  ...
  it('this year', () => {
    const engine = HyperFormula.buildFromArray([
      ...
      ['=WORKDAY_INTL("01/01/2020", 262, 1)'],
      ['=WORKDAY_INTL("01/01/2020", 262, 1, A1:A1)'],
      ['=WORKDAY_INTL("01/01/2020", 262, 1, A1:B1)'],
      ['=WORKDAY_INTL("01/01/2020", 262, 1, A1:D1)'],
      ['=WORKDAY_INTL("01/01/2020", 262, 1, A1:E1)'],
    ])
  ...
  it('should output correct values', () => {
    const engine = HyperFormula.buildFromArray([
      ...
      ['=WORKDAY_INTL(A1, 91, "0000000", A1:J1)'],
      ['=WORKDAY_INTL(A1+7, 9, "0000000", A1:J1)'],
      ['=WORKDAY_INTL(A1+7, 86, "0000000", A1:J1)'],
      ['=WORKDAY_INTL(A1+13, 34, "0000000", A1:J1)'],
      ['=WORKDAY_INTL(A1+50, 5, "0000000", A1:J1)'],
    ])
  ...
  it('checks types in last argument', () => {
    const engine = HyperFormula.buildFromArray([
      [true, '\'1', null, '=NA()'],
      ['=WORKDAY_INTL(1000, 1, 1, A1:A1)'],
      ['=WORKDAY_INTL(1000, 1, 1, B1:B1)'],
      ['=WORKDAY_INTL(1000, 1, 1, C1:C1)'],
      ['=WORKDAY_INTL(1000, 1, 1, A1:D1)'],
    ])
